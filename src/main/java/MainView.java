...
public class MainView extends VBox {
    ...
    MainView(double w, double h, double x) {
        ...
        ui.setScrollAction(new ChangeListener<Number>() {
            @Override
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                affine = new Affine();
                affine.appendScale( width/newValue.doubleValue(), height/newValue.doubleValue());
                simulation.setNewSize(newValue.intValue());
                draw();
            }
        });
